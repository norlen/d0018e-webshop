...
export const NO_PRODUCTS_IN_ORDER = 7;
...
export const mapError = (code: number, message: string): string => {
  switch (code) {
    ...
    case INCONSISTENT_CART:
      return "Vängligen ladda om sidan, något har visst hänt med kundvagnen";
    ...
    case NO_PRODUCTS_IN_ORDER:
      return "Måste finnas minst en produkt i ordern";
